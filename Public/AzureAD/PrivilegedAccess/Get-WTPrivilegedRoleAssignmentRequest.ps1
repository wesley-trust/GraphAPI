function Get-WTPrivilegedRoleAssignmentRequest {
    [CmdletBinding()]
    param (
        [parameter(
            Mandatory = $false,
    ...
    Process {
        try {
            ...
            if ($AccessToken) {
                ...
                # Set resource
                $Uri = "privilegedAccess/aadRoles/resources/$TenantId/roleAssignmentRequests"
                ...
                if ($QueryResponse) {
                    ...
                    $WarningMessage = "No requests exist in Azure AD, or with parameters specified"
