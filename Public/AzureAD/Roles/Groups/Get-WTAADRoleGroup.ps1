    ...
    Process {
        try {
            ...
            if ($AccessToken) {
                ...
                $RoleGroups = Get-WTAzureADGroup @Parameters | Where-Object {$_.$Tag -eq $Service}
                ...
                if ($RoleGroups) {
                    ...
                    $WarningMessage = "No Role groups exist in Azure AD, or with the specified IDs"
