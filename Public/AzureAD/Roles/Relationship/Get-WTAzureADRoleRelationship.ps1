function Get-WTAzureADRoleRelationship {
    [CmdletBinding()]
    param (
        [parameter(
            Mandatory = $false,
    ...
    Process {
        try {
            ...
            if ($AccessToken) {
                ...
                # Get Azure AD role relationship
                ...
                if ($QueryResponse) {
                    ...
                    $WarningMessage = "No role $Relationship exist in Azure AD for any of the role IDs specified"
