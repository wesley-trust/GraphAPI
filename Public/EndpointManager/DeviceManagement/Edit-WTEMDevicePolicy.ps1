function Edit-WTEMDevicePolicy {
    [cmdletbinding()]
    param (
        [parameter(
            Mandatory = $false,
    ...
    Begin {
        try {
            ...
            # Variables
            $Activity = "Updating Endpoint Manager Device $PolicyType policies"
            $CleanUpProperties = (
                "id",
                "createdDateTime",
        ...
        try {
            ...
            if ($AccessToken) {
                ...
                if ($DevicePolicies) {
                    ...
                    $ErrorMessage = "There are no Endpoint Manager Device $PolicyType policies to be updated"
