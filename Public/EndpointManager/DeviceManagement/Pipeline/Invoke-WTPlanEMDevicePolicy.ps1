function Invoke-WTPlanEMDevicePolicy {
    [CmdletBinding()]
    param (
        [parameter(
            Mandatory = $false,
    ...
    Process {
        try {
            ...
            if ($AccessToken) {
                ...
                Write-Host "Evaluating Endpoint Manager Device Policies"
                    ...
                    if ($ExistingPolicies) {
                        ...
                        if ($EMDevicePolicies) {
                            ...
                            $PolicyComparison = Compare-Object `
                                ...
                                -DifferenceObject $EMDevicePolicies `
                                -Property id `
                                -PassThru
                        ...
                        if ($UpdateExistingPolicies) {
                            if ($EMDevicePolicies) {
                                ...
                                $UpdatePolicies = foreach ($Policy in $EMDevicePolicies) {
                        ...
                        $CreatePolicies = $EMDevicePolicies
                    }
                }
                else {
                ...
                $PlanEMDevicePolicies = [ordered]@{}

                if ($RemovePolicies) {
                    $PlanEMDevicePolicies.Add("RemovePolicies", $RemovePolicies)
                ...
                if ($UpdatePolicies) {
                    $PlanEMDevicePolicies.Add("UpdatePolicies", $UpdatePolicies)
                ...
                if ($CreatePolicies) {
                    $PlanEMDevicePolicies.Add("CreatePolicies", $CreatePolicies)
                ...
                if ($PlanEMDevicePolicies) {
                    $PlanEMDevicePolicies = [PSCustomObject]$PlanEMDevicePolicies
                    $PlanEMDevicePolicies
                }
            }
            else {
