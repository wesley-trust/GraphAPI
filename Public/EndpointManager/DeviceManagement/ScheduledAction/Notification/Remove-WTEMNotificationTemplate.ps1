function Remove-WTEMNotificationTemplate {
    ...
    param (
        ...
        [parameter(
            ...
            HelpMessage = "Specify the notification template Ids to remove"
        )]
        [Alias("NotificationTemplateId", "Id", "NotificationTemplateIds")]
        [string]$Ids
    )
    Begin {
        try {
            ...
            # Variables
            $Activity = "Removing Endpoint Manager Notification Template"
    ...
    Process {
        try {
            ...
            if ($AccessToken) {
                ...
                # If there are templates to be removed, remove them
                if ($IDs) {
                    ...
                    $ErrorMessage = "There are no Ids specified which are required to remove notification templates"
